...
class birdTag:
    ...
    def create_regularised_behaviours(
        self
        ):
        """
        ...
        if self.tag_type != 'dvl':
            ...
            self.dvl_beh['rounded_time'] = [self.round_seconds(x) for x in self.dvl_beh.Time]
    ...
    def upsample_behaviours(
            self,
            behaviours_duration: int = 2
        ) -> None:
        """
